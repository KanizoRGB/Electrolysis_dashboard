                ...
                <CardBody style={{ padding: 15, paddingTop: 0 }}>
                  ...
                  <Row>
                    ...
                    <Col xs="5">
                      ...
                      >
                        {chamber[0].data[chamber[0].data?.length - 1]} {chamber[0].yLabel}
                      </p>
                    </Col>
                  </Row>
                  <Row>
                  ...
                  <Row>
                    ...
                    <Col xs="5">
                      ...
                      >
                        {chamber[1].data[chamber[1].data?.length - 1]} {chamber[1].yLabel}
                      </p>
                    </Col>
                  </Row>
                  <Row>
                  ...
                  <Row>
                    ...
                    <Col xs="5">
                      <p className="text-right">{chamber[2].data[0]} {chamber[2].yLabel}</p>
                    </Col>
                  </Row>
                </CardBody>
              </Card>
